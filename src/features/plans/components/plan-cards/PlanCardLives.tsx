...
export function PlanCardLives({ plan, onEdit, onToggleActive, onDelete }: PlanCardLivesProps) {
  return (
    <Card className="p-4 bg-white border border-gray-200 shadow-sm h-full">
      ...
      <div className="space-y-2 mb-4">
        <div className="flex justify-between text-sm">
          <span className="text-foreground/60">Tiempo Total de Lives:</span>
          <span className="font-medium text-foreground">{plan.livesDurationMinutes} min</span>
        </div>
        <div className="flex justify-between text-sm">
